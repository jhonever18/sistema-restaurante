    ...
    <div class="flex min-h-screen  z-10 relative">
        ...
        <div class=" w-11/12  mt-5  border-[#784212] border p-6 m-6 rounded-lg shadow-md">
               ...
               // Obtener página actual
                ...
                $total_pedidos_query = mysqli_query($connect, "SELECT COUNT(*) AS total FROM pedidos");
                ...
                <div class="mt-6 flex justify-center space-x-2">
                    <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
                        <a href="?pagina=<?= $i ?>" class="px-4 py-2 <?= $i == $pagina ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300' ?> rounded"><?= $i ?></a>
                    <?php endfor; ?>
                </div>
